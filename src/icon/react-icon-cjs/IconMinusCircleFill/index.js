  ...
  var props = _objectSpread(
    ...
    {},
    {
      className: ''
        ...
        .concat(prefixCls, '-icon-minus-circle-fill'),
    },
  );
...
var IconMinusCircleFill = /*#__PURE__*/ _react['default'].forwardRef(IconMinusCircleFillComponent);

IconMinusCircleFill.defaultProps = {
  isIcon: true,
};
IconMinusCircleFill.displayName = 'IconMinusCircleFill';
var _default = IconMinusCircleFill;
