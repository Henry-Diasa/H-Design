  ...
  var props = _objectSpread(
    ...
    {},
    {
      className: ''
        ...
        .concat(prefixCls, '-icon-plus-circle-fill'),
    },
  );
...
var IconPlusCircleFill = /*#__PURE__*/ _react['default'].forwardRef(IconPlusCircleFillComponent);

IconPlusCircleFill.defaultProps = {
  isIcon: true,
};
IconPlusCircleFill.displayName = 'IconPlusCircleFill';
var _default = IconPlusCircleFill;
